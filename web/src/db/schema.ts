...
export const gameServers = pgTable(
    ...
    (table) => ({
        ...
        lastHeartbeatIdx: index('game_servers_last_heartbeat_idx').on(
            table.lastHeartbeat
        ),
    })
)
...
export const playerStats = pgTable(
    ...
    (table) => ({
        ...
        lastPlayedAtIdx: index('player_stats_last_played_at_idx').on(
            table.lastPlayedAt
        ),
    })
)
...
export const changelogEntries = pgTable(
    ...
    (table) => ({
        publishedAtIdx: index('changelog_entries_published_at_idx').on(
            table.publishedAt
        ),
    })
)
