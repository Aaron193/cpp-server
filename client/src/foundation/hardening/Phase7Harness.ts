...
const localState = { handle: { slot: 1, generation: 1 }, position: { x: 0, y: 0, z: 0 }, velocity: { x: 0, y: 0, z: 0 }, bodyYaw: 0, aimPitch: 0, grounded: true, stateFlags: 0, health: 100, movementState, weaponState: { selected: Weapon.Rifle, magazineAmmo: 30, reserveAmmo: 120, stateFlags: 0, aimProgress: 0, spreadRadians: .012, recoilPitch: 0, recoilYaw: 0, recoilSequence: 0 } }
...
export function runPhase7Hardening(): Phase7Report {
    ...
    return {
        ...
        methodology: { kind: 'deterministic pairwise discrete-event simulation plus accelerated bounded-state soak', scenarioCount: scenarios.length, simulatedSeconds: totals.simulatedSeconds, note: 'Encoding uses the generated v8 implementation. This is not a live socket, browser GPU, or hardware performance claim.' },
